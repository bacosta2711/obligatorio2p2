...
public class NewInterviewer extends javax.swing.JFrame {

    
    public NewInterviewer() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(NewInterviewer.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new NewInterviewer().setVisible(true);
            }
        });
    }
